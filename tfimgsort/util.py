...
def setup_dirs(labels, directory):
    """Given a list of labels creates corresponding subdirectories in the
    target directory.

    Given the labels ['a', 'b', 'c'] and the directory '1' the following
    ...
    If the parent directory does not exist it, and it's parents if
